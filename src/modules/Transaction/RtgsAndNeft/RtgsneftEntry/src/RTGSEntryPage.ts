...
export class RTGSEntryPage extends BasePage {
  readonly pageTitle = 'RTGS Entry';
  readonly pageUrl = CBS_CONSTANTS.ROUTES.RTGS_ENTRY;
  ...
  async fillForm(data: RTGSFormData): Promise<void> {
